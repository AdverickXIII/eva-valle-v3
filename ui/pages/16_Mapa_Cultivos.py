"""Pagina 16: Mapa coropletico por cultivo."""
...
st.set_page_config(page_title="Mapa Cultivos | EVA Valle", page_icon="\U0001F5FA\uFE0F", layout="wide")
...
def main() -> None:
    st.title("\U0001F5FA\uFE0F Mapa Coropletico por Cultivo")
