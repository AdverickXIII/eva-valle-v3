"""
Setup script: genera los 11 archivos de puertos (interfaces abstractas).
Ejecutar una sola vez: python scripts/setup_ports.py
"""
from pathlib import Path

# ═══════════════════════════════════════════════════════════
# ARCHIVO 1: core/ports/__init__.py
# ═══════════════════════════════════════════════════════════
PORTS_INIT = '''"""
...
# ═══════════════════════════════════════════════════════════
# ARCHIVO 2: core/ports/in/__init__.py
# ═══════════════════════════════════════════════════════════
PORTS_IN_INIT = '''"""
Puertos de ENTRADA: definen lo que el mundo exterior (Streamlit, API, CLI)
puede solicitar al nucleo de dominio.

Cada puerto es un Protocol (interfaz estructural). Los casos de uso
del nucleo implementan estos protocolos.
"""
from core.ports.in.data_loader_port import DataLoaderPort
from core.ports.in.audit_port import AuditPort
from core.ports.in.analytics_port import AnalyticsPort
from core.ports.in.diagnostics_port import DiagnosticsPort
from core.ports.in.ml_port import MLPort
...
# ═══════════════════════════════════════════════════════════
# ARCHIVO 3: core/ports/in/data_loader_port.py
# ═══════════════════════════════════════════════════════════
DATA_LOADER_PORT = '''"""
...
# ═══════════════════════════════════════════════════════════
# ARCHIVO 4: core/ports/in/audit_port.py
# ═══════════════════════════════════════════════════════════
AUDIT_PORT = '''"""
...
# ═══════════════════════════════════════════════════════════
# ARCHIVO 5: core/ports/in/analytics_port.py
# ═══════════════════════════════════════════════════════════
ANALYTICS_PORT = '''"""
...
# ═══════════════════════════════════════════════════════════
# ARCHIVO 6: core/ports/in/diagnostics_port.py
# ═══════════════════════════════════════════════════════════
DIAGNOSTICS_PORT = '''"""
...
# ═══════════════════════════════════════════════════════════
# ARCHIVO 7: core/ports/in/ml_port.py
# ═══════════════════════════════════════════════════════════
ML_PORT = '''"""
...
# ═══════════════════════════════════════════════════════════
# ARCHIVO 8: core/ports/out/__init__.py
# ═══════════════════════════════════════════════════════════
PORTS_OUT_INIT = '''"""
Puertos de SALIDA: definen lo que el nucleo de dominio necesita
del mundo exterior (persistencia, descarga, serializacion).
...
"""
from core.ports.out.storage_port import StoragePort
from core.ports.out.downloader_port import DownloaderPort
from core.ports.out.model_registry_port import ModelRegistryPort
...
# ═══════════════════════════════════════════════════════════
# ARCHIVO 9: core/ports/out/storage_port.py
# ═══════════════════════════════════════════════════════════
STORAGE_PORT = '''"""
...
# ═══════════════════════════════════════════════════════════
# ARCHIVO 10: core/ports/out/downloader_port.py
# ═══════════════════════════════════════════════════════════
DOWNLOADER_PORT = '''"""
...
# ═══════════════════════════════════════════════════════════
# ARCHIVO 11: core/ports/out/model_registry_port.py
# ═══════════════════════════════════════════════════════════
MODEL_REGISTRY_PORT = '''"""
...
if __name__ == "__main__":
    archivos = {
        "core/ports/__init__.py": PORTS_INIT,
        "core/ports/in/__init__.py": PORTS_IN_INIT,
        "core/ports/in/data_loader_port.py": DATA_LOADER_PORT,
        "core/ports/in/audit_port.py": AUDIT_PORT,
        "core/ports/in/analytics_port.py": ANALYTICS_PORT,
        "core/ports/in/diagnostics_port.py": DIAGNOSTICS_PORT,
        "core/ports/in/ml_port.py": ML_PORT,
        "core/ports/out/__init__.py": PORTS_OUT_INIT,
        "core/ports/out/storage_port.py": STORAGE_PORT,
        "core/ports/out/downloader_port.py": DOWNLOADER_PORT,
        "core/ports/out/model_registry_port.py": MODEL_REGISTRY_PORT,
    }
    ...
    print(f"\n{creados} archivos de puertos creados.")
    print('Ejecuta: python -c "from core.ports.in.analytics_port import AnalyticsPort; print(\'OK\')"')