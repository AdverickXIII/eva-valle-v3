"""Comparador pro: tabla con ganador, sin cana, mariposa, radar y CSV."""
from pathlib import Path

PAGE = '''"""Pagina 11: Comparador de municipios (cara a cara profesional)."""
...
print("[OK] 11_Comparador.py transformado en cara a cara profesional")
print("Reinicia Streamlit y prueba: Palmira vs Dagua, con y sin caña")