"""Pagina Validacion Satelital v4: mosaico estilo tiles, sin barra de color."""
from pathlib import Path

PAGE = '''"""Pagina 18: Validacion Satelital v4 (mosaico estetico)."""
...
print("[OK] ui/pages/18_Satelite.py (v4: mosaico tiles + leyenda limpia)")