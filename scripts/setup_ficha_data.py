"""Crea core/reports/crop_data.py: estadisticas y concentracion por cultivo."""
from pathlib import Path

DATA = '''"""Estadisticas y concentracion territorial por cultivo (ficha tecnica)."""
...
Path("core/reports/crop_data.py").write_text(DATA, encoding="utf-8")
print("[OK] core/reports/crop_data.py")
print("Sigue: python scripts\\setup_ficha_report.py")