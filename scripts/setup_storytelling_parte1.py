"""PARTE 1: Informe Ejecutivo Narrativo (portada + capitulos 1-3)."""
from pathlib import Path

PARTE1 = r'''"""Informe Ejecutivo Narrativo: storytelling de 10 capitulos."""
...
Path("core/reports/storytelling_report.py").write_text(PARTE1, encoding="utf-8")
print("[OK] Parte 1 creada (portada + capitulos 1-3)")
print("Sigue: python scripts\\setup_storytelling_parte2.py")