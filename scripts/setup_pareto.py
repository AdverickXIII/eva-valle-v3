"""Crea core/analytics/pareto.py: concentracion dual (con/sin cana), territorial, calidad."""
from pathlib import Path

PARETO = '''"""Analisis de concentracion dual (con/sin cana), territorial y calidad."""
...
Path("core/analytics/pareto.py").write_text(PARETO, encoding="utf-8")
print("[OK] core/analytics/pareto.py")
print("Sigue: python scripts\\setup_ejecutivo_dual.py")